...
if __name__ == "__main__":
    ...
    print(device)
    model = invertedResidual_unet(1).to(device)
    dataset_dir_path = '/home/yonghu/data_yonghu/code_python/VitalDB_DataLoader_tol/Folder' + fold_number + '/'

    weight_dir = 'weight_model/'
    create_folder_if_not_exists(weight_dir)
    weight_path = weight_dir + MODEL_NAME + '_VitalDB_Fold' + fold_number + '_'
