...
def load_data_pulseDB(idx):
    ...
    x_train_load_data = x_tol_arr[0:8]
    x_val_load_data = x_tol_arr[9:10]
    x_test_load_data = x_tol_arr[8:9]
    ...
    y_train_load_data = y_tol_arr[0:8]
    y_val_load_data = y_tol_arr[9:10]
    y_test_load_data = y_tol_arr[8:9]
...
weight_path = "weight_model/UtransBPNet_VitalDB_Fold09_"
