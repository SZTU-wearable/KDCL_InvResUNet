...
def load_data_pulseDB(idx):
    ...
    x_train_load_data = x_tol_arr[8:10] + x_tol_arr[0:6]
    x_val_load_data = x_tol_arr[7:8]
    x_test_load_data = x_tol_arr[6:7]
    ...
    y_train_load_data = y_tol_arr[8:10] + y_tol_arr[0:6]
    y_val_load_data = y_tol_arr[7:8]
    y_test_load_data = y_tol_arr[6:7]
...
weight_path = "weight_model/UtransBPNet_VitalDB_Fold07_"
