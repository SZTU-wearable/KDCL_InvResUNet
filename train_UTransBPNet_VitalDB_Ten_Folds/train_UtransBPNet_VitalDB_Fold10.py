...
def load_data_pulseDB(idx):
    ...
    x_train_load_data = x_tol_arr[1:9]
    x_val_load_data = x_tol_arr[0:1]
    x_test_load_data = x_tol_arr[9:10]
    ...
    y_train_load_data = y_tol_arr[1:9]
    y_val_load_data = y_tol_arr[0:1]
    y_test_load_data = y_tol_arr[9:10]
...
weight_path = "weight_model/UtransBPNet_VitalDB_Fold10_"
