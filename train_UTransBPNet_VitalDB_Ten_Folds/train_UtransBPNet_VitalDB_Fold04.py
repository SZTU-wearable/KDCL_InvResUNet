...
def load_data_pulseDB(idx):
    ...
    x_train_load_data = x_tol_arr[5:10] + x_tol_arr[0:3]
    x_val_load_data = x_tol_arr[4:5]
    x_test_load_data = x_tol_arr[3:4]
    ...
    y_train_load_data = y_tol_arr[5:10] + y_tol_arr[0:3]
    y_val_load_data = y_tol_arr[4:5]
    y_test_load_data = y_tol_arr[3:4]
...
weight_path = "weight_model/UtransBPNet_VitalDB_Fold04_"
