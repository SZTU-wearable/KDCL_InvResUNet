...
def load_data_pulseDB(idx):
    ...
    x_train_load_data = x_tol_arr[9:10] + x_tol_arr[0:7]
    x_val_load_data = x_tol_arr[8:9]
    x_test_load_data = x_tol_arr[7:8]
    ...
    y_train_load_data = y_tol_arr[9:10] + y_tol_arr[0:7]
    y_val_load_data = y_tol_arr[8:9]
    y_test_load_data = y_tol_arr[7:8]
...
weight_path = "weight_model/UtransBPNet_VitalDB_Fold08_"
