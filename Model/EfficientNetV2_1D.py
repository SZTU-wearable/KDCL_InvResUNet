...
class ConvBNAct(nn.Module):
    def __init__(self,
        ...
        self.conv = nn.Conv1d(in_channels=in_planes,
...
class EfficientNetV2(nn.Module):
    def __init__(self,
        ...
        norm_layer = partial(nn.BatchNorm1d, eps=1e-3, momentum=0.1)

        stem_filter_num = model_cnf[0][4]

        self.stem = ConvBNAct(4,
                              stem_filter_num,
                              kernel_size=3,
                              stride=2,
        ...
        head.update({"avgpool": nn.AdaptiveAvgPool1d(1)})
...
def efficientnetv2_s(num_classes: int = 625):
    """
    EfficientNetV2
