...
class invertedResidual_small_unet(nn.Module):
    def __init__(self, out_planes=1):
        ...
        self.in_2 = InvertedResidual(in_planes=4, out_planes=16, kernel_size=3,
                                     exp_size=16, stride=2, use_se=0, use_hs=0, norm_layer=norm_layer)
        ...
        self.in_5 = InvertedResidual(in_planes=24, out_planes=40, kernel_size=5,
                                     exp_size=96, stride=2, use_se=0, use_hs=1, norm_layer=norm_layer)
        self.in_6 = InvertedResidual(in_planes=40, out_planes=40, kernel_size=5,
                                     exp_size=240, stride=1, use_se=0, use_hs=1, norm_layer=norm_layer)
        ...
        self.in_8 = InvertedResidual(in_planes=40, out_planes=48, kernel_size=5,
                                     exp_size=120, stride=1, use_se=0, use_hs=1, norm_layer=norm_layer)
        self.in_9 = InvertedResidual(in_planes=48, out_planes=48, kernel_size=5,
                                     exp_size=144, stride=1, use_se=0, use_hs=1, norm_layer=norm_layer)
        self.in_10 = InvertedResidual(in_planes=48, out_planes=96, kernel_size=5,
                                      exp_size=288, stride=2, use_se=0, use_hs=1, norm_layer=norm_layer)
        self.in_11 = InvertedResidual(in_planes=96, out_planes=96, kernel_size=5,
                                      exp_size=576, stride=2, use_se=0, use_hs=1, norm_layer=norm_layer)
